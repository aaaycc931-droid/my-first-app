...
export const LOCAL_PRACTICE_CATALOG_VERSION = 7 as const;
...
type LegacyCatalogTarget = {
  kind: Exclude<LocalPracticeKind, "chord-inversion" | "harmony-progression" | "scale-mode" | "seventh-chord" | "seventh-chord-spacing">;
