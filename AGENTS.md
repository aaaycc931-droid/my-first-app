...
截至 2026-07-19，P106–P113 与 P114a–P114k 已合并；P114k 通过 PR #377 合并，当前 main 为 `4300655455e1c98a86fac3858ac6200d2197fe60`。P114i 只冻结“共鸣之旅者”角色、世界观和最终头部资产，没有伙伴运行时。当前九类 Activity 输入均有真实使用者，P114 仍需补齐其余共享对象后才能整体完成。P114l 是 `MediaProject`、`ResourcePackage` 与 `CapabilityResolver` 的真实运行时候选：本地媒体项目不上传、不持久化，资源包摘要必须由实际资产复算，能力解析不得把静态 manifest 冒充已经成功解码。不得把自动测试、候选代码、CI、设备类型声明或角色设定冒充 USB/BLE 真机、伙伴运行时、P104 真实数据或教育证据。
