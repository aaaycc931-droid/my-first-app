...
截至 2026-07-23，P106–P113、P114a–P114m、P115a–P115i、P116a–P116d、P117a–P117e、P118a–P118e 已合并；P119a Q3 证据协议与 P119b 两个基础档 V1 数量候选已分别通过 PR #415、#417 合并。当前 30 个自动盘点组均达到每档至少 20 的数量前置，但专业每档 40、审核清单冻结、双教师签署和教育有效性仍未完成；下一步只能准备可复核清单与预先批准的抽样计划，不得自行填写教师结论。P114i 只冻结“共鸣之旅者”角色、世界观和最终头部资产，没有伙伴运行时。当前统一 Activity 输入以及 `MediaProject`、`ResourcePackage`、`CapabilityResolver`、`LearningEvent/Profile` 均有真实使用者；P115–P118 已交付相应 implementation candidates，但真实 Android、真实人声和教育审核仍是独立外部门槛。学习画像只可表达最小练习事实、错误、复练和建议原因，必须允许关闭建议与独立重置，并与正式能力评级、伙伴关系、账号和原始隐私数据分离。不得把自动测试、候选代码、CI、设备类型声明或角色设定冒充 USB/BLE 真机、伙伴运行时、P104 真实数据或教育证据。
