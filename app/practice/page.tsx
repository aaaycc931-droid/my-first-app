Warning: truncated output (original token count: 49346)
Total output lines: 4600
          ...
          onUseVoicedSpan={() =>
            setLocalTargetPitchCurveDraftReviewSelection(
              (currentSelection) => ({
                ...currentSelection,
                mode: "voiced-span",
  …9346 tokens truncated…             <h2 className="mt-1 text-2xl font-bold text-violet-950">{notationPracticePitchFeedbackContext.pitch} · 事件 {notationPracticePitchFeedbackContext.eventIndex + 1}</h2>
