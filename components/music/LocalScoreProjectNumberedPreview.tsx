                  ...
                  return (
                    ...
                    >
                      ...
                      {token.dynamicMark !== null ? (
                        <span
                          className="font-serif text-sm font-bold italic text-slate-700"
                          aria-hidden="true"
                      ...
                      {token.fermataMark !== null ? (
                        <span
                          className="font-serif text-sm font-bold text-slate-700"
                          aria-hidden="true"
                          data-testid={`local-score-numbered-fermata-mark-${token.eventId}`}
                        >
                          𝄐
                        </span>
                      ) : null}
                      ...
                      {token.type === "note" && token.fingering !== null ? (
                        <span
                          className="mt-1 block text-[11px] font-bold text-indigo-700"
                          data-testid={`local-score-numbered-fingering-${token.eventId}`}
                          aria-hidden="true"
                        >
                          指法 {token.fingering}
                        </span>
