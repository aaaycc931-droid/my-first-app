...
| V1-07 | 钢琴辅助 | IN_PROGRESS | Android 独立本地参考钢琴页与四类练习内嵌入口；三档 13 键音域、最多 8 音、音量、延音、全停、错误重试与行为测试；P94 run `29494421135` 两个 job PASS | 当前仍是 `triangle` 合成音；缺专业采样音色、88 键、≥32 复音、完整移动交互、录音/节拍器/循环、多音色、USB MIDI/MusicXML 学习链路和三档真机低延迟证据 |
...
产品所有者已于 2026-07-16 明确暂停项目。以下是恢复后的依赖顺序，不代表当前正在执行：

1. P106 专业音频/采样 provider 与 P111 专业音准数据/基准协议可并行启动；P104 最低真实证据继续保留，不能用路线文档替代。
