...
| V1-05 | 视唱与录音闭环 | IN_PROGRESS | Web 本地录音/回放；Android 用户主动实时音高帧、中文权限错误与后台释放 | Android 曲线/录音/回放、正式课程接入、分句复练、版本化云端记录、设备矩阵 |
...
| V1-23 | 发布证据包 | IN_PROGRESS | P100 run `29501929393` 两个 job PASS，artifact `8376849801` 的内部 APK SHA-256 与 ZIP digest 已核对，C1 已 PASS | P101 CI；汇总全部基准、设备、删除/恢复、教育和用户验收证据 |
| V1-24 | Android 本地 APK | IN_PROGRESS | Capacitor 离线工程、四题型三难度题库、实时曲线、会话录音、练声生成器、本机复练、参考钢琴、无网络权限；P100 artifact `8376849801` 内 APK SHA-256 为 `0b0d7a467eb82e8fa87d0d685a704fe433d0056b715d31ab679e5656265a77db`。 | P101 CI；真机目标同步/分段复练/麦克风/录音；跨版本复练、题库听感、钢琴；三档设备；专用 release 签名、升级与回滚 |
...
1. V1-24 Android 本地 APK：完成 P101 目标曲线与分段反馈 CI 后进入 P102 本地练习记录；同时准备首台真机目标同步、权限、延迟、人声准确度、录音回放、参考音调度和后台释放；当前不做 AAB、商店、TWA、域名关联或认证回跳。
