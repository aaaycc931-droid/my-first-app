...
| V1-04 | 系统课程与题库 | IN_PROGRESS | 基础课程；单音、音程、节奏持久化；P115a–P115i、P116a–P116d 与 P117a–P117e 已合并，形成和声、节奏、旋律听写／回唱／视唱的 implementation candidates | P118 课程、统计、复练与可解释推荐纵向闭环；双教师题量/难度/解释校准；Android 真实用户验证 |
...
产品所有者已明确恢复开发；P114a–P114m、P115a–P115i、P116a–P116d 与 P117a–P117e 已合并。下一教学主轴进入 P118a 中文课程路径与本地课程进度模型；角色设定不代表伙伴运行时，合并代码和自动测试也不代表真机、真实人声或教育证据。当前依赖顺序如下：
