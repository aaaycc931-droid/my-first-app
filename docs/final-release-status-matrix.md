...
| V1-04 | 系统课程与题库 | IN_PROGRESS | 基础课程；单音、音程、节奏持久化；P115a–P115i、P116a–P116d、P117a–P117e、P118a 课程路径、P118b 本机详细统计、P118c 本机薄弱点复练分组与 P118d 可解释非评分推荐已合并 | P118e 整合；双教师题量/难度/解释校准；Android 真实用户验证 |
...
| V1-12 | 学习历史与复习 | IN_PROGRESS | 私有 practice attempts、课程答案摘要；Android 本机最小错题队列；P114m 非评分画像已合并；P115a–P115i 已接入相应练习事实、复练与迁移；P118c 已合并；P118d 已合并并固定解释 MRU 队列首项，存储异常失败关闭 | P118e 整合；Web 历史 UI、正式技能画像、跨设备同步；Android 跨版本/跨重启和配额真机验证；教育审核 |
...
产品所有者已明确恢复开发；P114a–P114m、P115a–P115i、P116a–P116d、P117a–P117e、P118a–P118d 已合并。下一独立教学切片为 P118e；角色设定不代表伙伴运行时，合并代码和自动测试也不代表真机、真实人声或教育证据。当前依赖顺序如下：
