...
| V1-23 | 发布证据包 | IN_PROGRESS | P99 run `29500985893` 两个 job PASS，artifact `8376459594` 的内部 APK SHA-256 与 ZIP digest 已核对，C1 已 PASS | P100 CI；汇总全部基准、设备、删除/恢复、教育和用户验收证据 |
| V1-24 | Android 本地 APK | IN_PROGRESS | Capacitor 离线工程、四题型三难度题库、实时音高曲线、会话录音、本机复练、参考钢琴、无网络权限；P99 artifact `8376459594` 内 APK SHA-256 为 `d7dbc7b57628593b7421df5fb9f50654b62f357f19fb70f871e26562bef18b43`。 | P100 CI；真机麦克风/录音/参考音调度；跨版本复练、题库听感、钢琴；三档设备；专用 release 签名、升级与回滚 |
...
1. V1-24 Android 本地 APK：完成 P100 练声生成器 CI 后进入 P101 目标曲线与分段非评分反馈；同时准备首台真机权限、延迟、人声准确度、录音编码/回放、参考音调度和后台释放；当前不做 AAB、商店、TWA、域名关联或认证回跳。
