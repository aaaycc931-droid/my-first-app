...
| V1-07 | 钢琴辅助 | IN_PROGRESS | Android 独立页与四类练习内嵌入口；P106 已合并统一事件/provider 基础；P107 已在本地接入可追溯 Public Domain 三层采样、A0–C8 逻辑映射、触控力度选择、32 音状态上限、24-buffer LRU 与显式降级 | P107 待 CI；完整 88 键移动交互、录音/节拍器/循环、多音色、USB MIDI/MusicXML 学习链路和三档真机低延迟/听感证据仍缺 |
...
1. P106 专业音频/采样 provider 基础已在 PR #357 合并；P107 三层采样钢琴正在执行并等待 CI。P111 专业音准数据/基准协议可独立启动；P104 最低真实证据继续保留，不能用路线文档替代。
