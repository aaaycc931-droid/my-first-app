...
| V1-05 | 视唱与录音闭环 | IN_PROGRESS | Web 本地录音/回放；Android 实时曲线、会话录音/回放、版本化练声目标、目标叠加与分段非评分反馈 | 正式课程接入、自动分句、版本化云端记录、真机同步/延迟/录音设备矩阵 |
...
| V1-23 | 发布证据包 | IN_PROGRESS | P101 run `29502638657` 两个 job PASS，artifact `8377144432` 的 APK SHA-256 与 ZIP digest 已核对，C1 已 PASS | P102 CI；汇总全部基准、设备、删除/恢复、教育和用户验收证据 |
| V1-24 | Android 本地 APK | IN_PROGRESS | Capacitor 离线工程、三难度题库、实时曲线、会话录音、目标/分段反馈、本机复练与参考钢琴；P101 artifact `8377144432` 内 APK SHA-256 为 `e136f40a7a146d17537646016601c360bfbe24848c43aada7c3a4f595f0d7b63`。 | P102 CI；真机 IndexedDB/导出/目标同步/麦克风/录音；三档设备；专用 release 签名、升级与回滚 |
...
1. V1-24 Android 本地 APK：完成 P102 本机练声记录 CI 后进入 P103 高级观察诊断；同时准备首台真机 IndexedDB、导出、目标同步、权限、延迟、人声准确度、录音回放、参考音调度和后台释放；当前不做 AAB、商店、TWA、域名关联或认证回跳。
