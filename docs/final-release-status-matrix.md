...
产品所有者已完成 P113 的恢复开发，并要求在该切片合并后暂停运行时开发。当前依赖顺序如下：
...
3. 当前暂停，不启动 P114 或伙伴运行时。产品所有者再次明确恢复后，P114 冻结统一活动协议，并与 F1/F2/M0 的 NoteEvent、ScoreDocument、PracticeTarget、MediaProject、AnalysisEvidence、伙伴事件/工具和本地/云端 provider 契约汇合。
