...
| V1-08 | MusicXML/MXL | IN_PROGRESS | parser、fixture 与 dev import；P114k 最小确认 ScoreDocument；本机谱项目已有受控单 part/staff/voice 子集入口、blocking ledger、明确确认、原子私有持久化及既有双谱面/播放闭环 | 扩大受支持语义、候选内修正、MusicXML/MXL 导出与独立阅读器 round-trip；浏览器/Android 真机证据 |
