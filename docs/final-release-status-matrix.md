...
| V1-23 | 发布证据包 | IN_PROGRESS | P96 run `29498225599` 两个 job PASS，artifact `8375330934` 的内部 APK SHA-256 与 ZIP digest 已核对，C1 已 PASS | P97 CI；汇总全部基准、设备、删除/恢复、教育和用户验收证据 |
| V1-24 | Android 本地 APK | IN_PROGRESS | Capacitor 离线工程、四题型三难度题库、实时音高帧入口、本机复练、参考钢琴、无网络权限；P96 artifact `8375330934` 内 APK SHA-256 为 `d300ea6aef90d1c6749eae5a654f5b114f1a824ce1678d17adf04f62243c5935`。 | P97 CI；真机麦克风权限/延迟/准确度/后台释放；跨版本复练、题库听感、钢琴多指/延音；三档设备；专用 release 签名、升级与回滚 |
...
1. V1-24 Android 本地 APK：完成 P97 本地麦克风与实时音高引擎 CI 后进入 P98 专业滚动曲线；同时准备首台真机权限、延迟、人声准确度、后台释放、四类练习音频、钢琴、本机复练和断网回归；当前不做 AAB、商店、TWA、域名关联或认证回跳。
