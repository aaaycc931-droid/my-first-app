...
产品所有者已明确恢复开发；P114c 当前以最小完整 vertical slice 把临时乐谱节奏拍击接入统一活动协议。当前依赖顺序如下：
...
5. P114c 候选只把已确认临时乐谱节奏目标的 `tap` 输入、生命周期和非评分证据接入协议；不制作伙伴 UI、麦克风、谱面编辑答案、MIDI、持久历史或云端能力。它仍不是完整 P114。
6. P115–P118 教学泳道与 S（制谱/OMR）、A（伴奏/歌曲）、必要 C（云端/内容/教师）泳道按依赖滚动；钢琴 P106–P110 只补真实体验和证据缺口。
7. P119/Q 必须汇合算法、钢琴、教学、制谱、伴奏、云服务、教育和目标用户验收；P120 只是八产品范围明确的专业私测候选，不是公开最终版。
8. V1-03 / V1-02 / V1-15 Web 数据生命周期继续是正式 Web 责任；最终产品同时建设本地与中国区合规云端能力，当前离线优先不是终局。
