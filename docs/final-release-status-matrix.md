...
| V1-23 | 发布证据包 | IN_PROGRESS | P98 run `29500174037` 两个 job PASS，artifact `8376148510` 的内部 APK SHA-256 与 ZIP digest 已核对，C1 已 PASS | P99 CI；汇总全部基准、设备、删除/恢复、教育和用户验收证据 |
| V1-24 | Android 本地 APK | IN_PROGRESS | Capacitor 离线工程、四题型三难度题库、实时音高曲线、本机复练、参考钢琴、无网络权限；P98 artifact `8376148510` 内 APK SHA-256 为 `52c9669d0bd42f3bec94df72c57d985728a11557d73c849a395998cb1764996a`。 | P99 CI；真机麦克风权限/延迟/准确度/录音回放/后台释放；跨版本复练、题库听感、钢琴；三档设备；专用 release 签名、升级与回滚 |
...
1. V1-24 Android 本地 APK：完成 P99 录音、回放与会话生命周期 CI 后进入 P100 单音、音阶和音程练声生成器；同时准备首台真机权限、延迟、人声准确度、录音编码/回放、后台释放、钢琴、本机复练和断网回归；当前不做 AAB、商店、TWA、域名关联或认证回跳。
