...
| V1-21 | 内容与教学审核 | IN_PROGRESS | P119a 已合并自动盘点与双教师六维审核协议；P119b 已使当前 30 个盘点组均达到 V1 每档至少 20 的数量前置；P119c 已冻结绑定 source commit、内容版本、18 个真源文件和 SHA-256 的可复核清单 | 责任方在审核前批准抽样数量、分层与清单内 item ID；由 2 名独立教育审核者完成正确性、术语、难度递进、答案与解释验收；专业 40 目标另行补足 |
