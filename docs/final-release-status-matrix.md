...
| V1-04 | 系统课程与题库 | IN_PROGRESS | 基础课程；单音、音程、节奏持久化；P115a–P115i、P116a–P116d 与 P117a–P117e 已合并，覆盖和声/调式活动、节奏套件、旋律听写多输入、回唱与视唱 implementation candidate | P118 课程、统计、复练与可解释自适应；双教师题量/难度/解释校准；Android 真实用户验证 |
| V1-05 | 视唱与录音闭环 | IN_PROGRESS | Web 本地录音/回放；Android 实时曲线、录音、本机记录与 P103 观察；P112/P113 离线分析与分段对齐；P114f 固定 A4 麦克风 Activity；P117d/e 三音回唱与视唱已合并 | Web/Android 真麦克风 QA；P113/P114f/P117d/e 真实人声；正式课程/云端记录；P104 真机同步/延迟/录音设备矩阵 |
| V1-06 | 节奏练习与反馈 | IN_PROGRESS | 节拍器、tap/onset、延迟校准、DP 对齐、课程节奏听辨；P116a–P116d 节奏视读、回模、找错与听写已合并 | 真实数据基准、真实设备与拍手/乐器验证、长期记录与复练、教育审核 |
...
| V1-23 | 发布证据包 | IN_PROGRESS | P117e PR #399 的 run `29896738992` 已通过 `quality` 与 Android API 36 `android-local`；artifact `8520299089` 的 ZIP digest 与内部 Debug APK 摘要已独立核对 | P118 功能冻结、专用签名与 main 对应 APK 独立摘要证据、P104 真实数据/设备/教育证据、删除/恢复与用户验收证据 |
| V1-24 | Android 本地 APK | IN_PROGRESS | 离线题库、实时曲线/录音/目标/观察、本机记录/复练、P106–P117e 共享能力；PR #399 已通过 `android-local` Debug APK 门禁 | P118 功能完整候选、P104 三档真机/真实人声、专用签名、升级与前向回滚 |
...
产品所有者已明确恢复开发；P114a–P114m、P115a–P115i、P116a–P116d 与 P117a–P117e 已合并。下一教学切片进入 P118a 中文课程路径和课程进度模型；角色设定不代表伙伴运行时，合并代码、自动测试和 APK 工件也不代表真机、真实人声或教育证据。当前依赖顺序如下：
...
13. P116a–P116d 已通过 PR #391–#394 合并，P117a–P117e 已通过 PR #395–#399 合并；P117e 合并提交为 `c2fc6a8943c9c432c850f3d0c89455b378c2cdd5`。PR #399 的自动门禁形成 implementation candidate，Browser 真麦克风、三档 Android 真机、真实人声、教师与目标用户证据仍为 `NOT_EXECUTED`。
