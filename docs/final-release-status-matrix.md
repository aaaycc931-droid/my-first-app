...
| V1-13 | 音高算法基准 | IN_PROGRESS | 合成 fixture、真实声音计划、确定性测试、P104 13 项硬门禁评估器 | 200 合成/乐器、100 真实人声/20 位/4 类设备、冻结验收集、量化结果和专家审核 |
...
1. V1-24 Android 本地 APK：P104 仓库内硬门禁已建立；当前需要真实人声、三档 Android 与教育审核原始证据，并在活动开始前冻结 `0.3.0` / versionCode `3` 的稳定私测签名候选。当前不做 AAB、商店、TWA、域名关联或认证回跳。
