...
当前执行检查点在 S3 MusicXML/MXL augmented／diminished 严格 round-trip 之后，
继续硬化每个 pitched note/rest 的外层 `<note>` 容器，拒绝属性、namespace 与大小写
变体；PR #476 已完成增三／减三和弦，PR #475 已完成 part identity，PR #474 已完成
