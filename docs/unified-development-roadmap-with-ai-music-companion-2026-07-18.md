...
当前执行检查点在 S3 MusicXML/MXL scoreCredits 与 GM1 program 严格 round-trip 之后，
继续硬化 `part-list → score-part → part-name` 和内容 `part` 的 identity 载体，拒绝
静默 trim、namespace／大小写变体、额外属性与非纯文本节点；PR #474 已完成 GM1
program，PR #473 已完成 scoreCredits，PR #466 已完成 XML 1.0 文本 fail-closed。仓库
