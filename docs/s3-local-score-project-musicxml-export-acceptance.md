...
- note/rest 的 canonical `chordSymbol` 只接受根音 `A–G` 后可选单个 ASCII
  `#`／`b` 的无后缀、`m`、`7`、`maj7`、`m7`、`6`、`m6`、`sus2`、`sus4`、`5`、`aug`、`dim`、`aug7`、
  `dim7` 或 `m7b5`
  形式，分别确定性
  写为 major、minor、dominant、major-seventh、minor-seventh、major-sixth、minor-sixth、suspended-second、suspended-fourth、power、
