...
The Android local reference piano is also outside this cloud pipeline: it synthesizes temporary reference tones on the device, stores and uploads no performance, requests no network or recording permission, and produces no score or analysis result.
