...
assert.match(practiceRhythmDiagnosticSource, /使用检测到的起音生成节奏反馈/);
assert.match(practiceRhythmDiagnosticSource, /recording-start/);
assert.match(practiceRhythmDiagnosticSource, /first-onset/);
assert.match(practiceRhythmDiagnosticSource, /首个检测到的起音/);
assert.match(practiceRhythmDiagnosticSource, /对齐诊断/);
assert.match(practiceRhythmDiagnosticSource, /标记 #/);
assert.match(practiceRhythmDiagnosticSource, /候选索引|candidateIndex/);
assert.match(practiceRhythmDiagnosticSource, /targetMarkers/);
assert.match(practiceRhythmDiagnosticSource, /firstOnsetOrigin|首个起音/);
