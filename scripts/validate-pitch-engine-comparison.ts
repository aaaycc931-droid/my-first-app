import { runPitchEngineComparisonHarness } from "../lib/practice/pitchEngineComparison";
...
console.log(
  "This is a reporting-only comparison harness skeleton, not a professional accuracy claim, not formal scoring, and not a gate change.",
);
console.log(
...
console.log("Baseline comparison rows:");
